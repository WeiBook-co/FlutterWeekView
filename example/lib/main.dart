  ...
  Widget build(BuildContext context) {
    ...
    return DayView(
      ...
      style: DayViewStyle.fromDate(
          ...
          timeBlocks: [
            TimeBlock(
              startTime: HourMinute(hour: 0, minute: 0),
              endTime: HourMinute(hour: 3, minute: 0),
              color: Colors.red.withOpacity(0.3),
            ),
            TimeBlock(
              startTime: HourMinute(hour: 20, minute: 0),
              endTime: HourMinute(hour: 24, minute: 0),
